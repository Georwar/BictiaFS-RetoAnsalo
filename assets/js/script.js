...
botonC3.addEventListener("click", () => {
  ...
  if (
    ...
    swal(
      "Advertencia!",
      "Debes ingresar primero los botones A y B!",
      "warning"
    );
  }
});
...
botonD4.addEventListener("click", () => {
  ...
  if (
    ...
    swal(
      "Advertencia!",
      "Debes ingresar primero los botones A,B y C!",
      "warning"
    );
  }
});
...
botonE5.addEventListener("click", () => {
  if (
    ...
    swal(
      "Advertencia!",
      "Debes ingresar primero los botones A,B,C Y D!",
      "warning"
    );
  }
});
...
botonF6.addEventListener("click", () => {
  if (
    ...
    swal(
      "Advertencia!",
      "Debes ingresar primero los botones A,B,C,D y E!",
      "warning"
    );
  }
});
...
botonG7.addEventListener("click", () => {
  if (
    ...
    swal(
      "Advertencia!",
      "Debes ingresar primero los botones A,B,C,D,E y F!",
      "warning"
    );
  }
});
...
botonH8.addEventListener("click", () => {
  if (
    ...
    swal(
      "Advertencia!",
      "Debes ingresar primero los botones A,B,C,D,E,F y G !",
      "warning"
    );
  }
});
...
botonI9.addEventListener("click", () => {
  if (
    ...
    swal(
      "Advertencia!",
      "Debes ingresar primero los botones A,B,C,D,E,F,G y H !",
      "warning"
    );
  }
});
...
botonJ0.addEventListener("click", () => {
  if (
    ...
    document.getElementById("letras").value = arrayLetras;
    swal("Exitoso!", "Has completado el campo Letras! Por favor ahora ingresa el campo numeros", "success");
    ...
    swal(
      "Advertencia!",
      "Debes ingresar primero los botones A,B,C,D,E,F,G,H y I !",
      "warning"
    );
  }
});
...
botonE5.addEventListener("click", () => {
  ...
  if (
    ...
    swal(
      "Advertencia!",
      "Debe ingresar primero el boton 1,2,3 y 4 !",
      "warning"
    );
  }
});
...
botonF6.addEventListener("click", () => {
  ...
  if (
    ...
    swal(
      "Advertencia!",
      "Debe ingresar primero el boton 1,2,3,4 y 5!",
      "warning"
    );
  }
});
...
botonG7.addEventListener("click", () => {
  ...
  if (
    ...
    swal(
      "Advertencia!",
      "Debe ingresar primero el boton 1,2,3,4,5 y 6!",
      "warning"
    );
  }
});
...
botonH8.addEventListener("click", () => {
  ...
  if (
    ...
    swal(
      "Advertencia!",
      "Debe ingresar primero el boton 1,2,3,4,5,6 y 7 !",
      "warning"
    );
  }
});
...
botonI9.addEventListener("click", () => {
  ...
  if (
    ...
    swal(
      "Advertencia!",
      "Debe ingresar primero el boton 1,2,3,4,5,6,7 y 8 !",
      "warning"
    );
  }
});
...
botonJ0.addEventListener("click", () => {
  ...
  if (
    ...
    document.getElementById("numeros").value = arrayNumeros;
    swal("Exitoso!", "Has completado el campo Numeros! Gracias por participar!", "success");
  } else if (arrayNumeros[9] == "0" && arrayLetras.length == 10) {
    swal("Advertencia!", "El boton 0 ya fue ingresado!", "warning");
  } else if (arrayNumeros[9] != "0" && arrayLetras[9] == "J" && arrayNumeros.length != 0) {
    swal(
      "Advertencia!",
      "Debe ingresar primero el boton 1,2,3,4,5,6,7,8 y 9 !",
      "warning"
    );
  }
});
...
botonNN.addEventListener("click", () => {
  window.location.href = 'http:/calculadora.html'
